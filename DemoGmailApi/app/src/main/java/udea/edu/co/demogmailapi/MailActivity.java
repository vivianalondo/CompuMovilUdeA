package udea.edu.co.demogmailapi;
...
import udea.edu.co.demogmailapi.helper.InternetDetector;
import udea.edu.co.demogmailapi.helper.Utils;
...
public class MailActivity extends AppCompatActivity {
    ...
    private void chooseAccount(View view) {
        if (Utils.checkPermission(getApplicationContext(), android.Manifest.permission.GET_ACCOUNTS)) {
            ...
            ActivityCompat.requestPermissions(MailActivity.this,
                    new String[]{android.Manifest.permission.GET_ACCOUNTS}, Utils.REQUEST_PERMISSION_GET_ACCOUNTS);
        }
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        MakeRequestTask(MailActivity activity, GoogleAccountCredential credential) {
